...
public class IncidentRepository implements IIncidentRepository {
    ...
    @Override
    public List<IncidentEntity> findAllEntityTODO() {
        return incidentJpaRepository.findAllEntityTODO();
    }

    @Override
    public List<Incident> findAllEntityONGOING() {
        List<IncidentEntity> incidentEntityList = incidentJpaRepository.findAllEntityONGOING();
    ...
    @Override
    public void saveOne(IncidentEntity incidentEntity){
